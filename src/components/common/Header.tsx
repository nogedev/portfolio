...
import { connectLinksItems } from "../../const";
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between py-6">
          ...
          <div class="gap-6 flex items-center">
            <div className="gap-6 flex items-center">
              <a href={connectLinksItems[0].href} className="bg-gray-100 p-1.5" target="_blank" rel="noopener noreferrer">
              ...
              <a href={connectLinksItems[1].href} className="bg-gray-100 p-1.5" target="_blank" rel="noopener noreferrer">
                <svg xmlns="http://www.w3.org/2000/svg" className="size-6" viewBox="0 0 1024 1024">
